...
class UPerHead(nn.Module):
    ...
    def __init__(self, in_channels=[96, 192, 384, 768], num_classes=40, channels=512, pool_scales=(1, 2, 3, 6),
                 norm_layer=nn.BatchNorm2d, dropout_ratio=0.1, align_corners=False):
